...
var text1 ='{"nameXAxis": "Zeit", "data": [{"pointid": null, "starttime": 1454396400000, "endtime": 1454409000000, "comment": "Gestörter Bauablauf", "y": 3, "yOriginal":3, "color": "#e57373", "Status": 3, "hasChildren":false }, { "pointid": null, "starttime": 1454412000000, "endtime": 1454414400000, "comment": "", "y": 3, "yOriginal":3, "Status": 3, "color": "#ff9800", "hasChildren":false }, { "starttime": 1454414400000, "endtime": 1454421298000, "comment": "", "y": 5, "yOriginal":5, "Status": 3, "color": "#3f51b5", "hasChildren":false }, { "pointname": "258F_01213a1_1_2", "pointid": 9149, "starttime": 1454420000000, "endtime": 1454422301000, "comment": null, "y": 1, "yOriginal":1, "Status": 3, "color": "#2196f3","hasChildren":false }, { "pointid": null, "starttime": 1454422374000, "endtime": 1454423442000, "comment": null, "y": 2, "yOriginal":2, "Status": 3, "color": "#81d4fa", "hasChildren":false } ]}';
...
this.post('/basedata', function(db, request) {
	...
	for (let k=0; k<extraData.length;k++) {
		if(extraData[k].y==yPos)
		{
			if(extraData[k].endtime<=enTime)
			{
				if(extraData[k].starttime>=stTime)
				{
					{
